  ...
  const Consulting = ({ isCollapsed }) => {
                ...
                productEntries: productEntries.map((entry, i) =>
                  i === index
                    ? {
                        ...
                        quantity:
                          productDetails.product_id === "Consulting" ? "1" : entry.quantity || "",
    ...
    const saveWorkOrder = useCallback(async () => {
      ...
      try {
        ...
        if (isEditing) {
          payload.sales_order_id = workOrderId;
    ...
    const fetchWorkOrderDetails = useCallback(async () => {
      try {
        ...
        if (error) {
          ...
          const formattedProductEntries = data.items.map((entry) => ({
            id: entry.product_id,
