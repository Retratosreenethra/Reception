    ...
    <div className={`transition-all duration-300 ${isCollapsed ? 'ml-0' : 'ml-14'} my-8 pt-9 min-h-screen`}>
      {showSplash ? (
        ...
        <div className="space-y-5">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center lg:space-x-6 mx-6">
          {/* Purchase Section */}
            ...
            {role !== 'admin' && role !== 'super_admin' && (
              <div className="flex items-center justify-center flex-col lg:flex-row lg:space-x-6 mt-10 lg:mt-0 w-full lg:w-1/2">
              {/* Work Order Container */}
                <div
                  ...
                  onClick={() => navigate('/insurance_cr')}
                >
                  <WrenchScrewdriverIcon className='h-36 w-36 text-green-500' />
                  <h2 className="text-xl text-gray-800 mt-4">Capture CR</h2>
                </div>
                ...
                <div
                  ...
                  onClick={() => navigate('/CaptureCR')}
                >
                  <TicketIcon className='h-36 w-36 text-green-500' />
                  <h2 className="text-xl text-gray-800 mt-4">CGHS</h2>
                </div>
            ...
            {role !== 'employee' && (
              <div className="flex flex-col lg:flex-row lg:space-x-6 mt-10 lg:mt-0 w-full lg:w-1/2">
                ...
                >
                  <ChatBubbleBottomCenterIcon className='h-36 w-36 text-green-500 mr-2' />
                ...
                >
                  ...
                  <h2 className="text-xl text-gray-800 mt-4">ALL S_IDs</h2>
                </div>
          ...
          {role === 'employee' && (
            <div className="flex flex-col lg:flex-row lg:space-x-6 mt-10 px-6 lg:mt-0 w-full lg:w-full">
              ...
              >
                <ChatBubbleBottomCenterIcon className='h-36 w-36 text-green-500 mr-2' />
                <h2 className="text-xl text-gray-800 mt-4">ECHS</h2>
              </div>

              {/* Stock Management Container */}
              <div
                className="flex flex-col items-center bg-green-50 shadow-lg rounded-lg p-6 cursor-pointer hover:shadow-xl transition duration-200 w-full mt-6 lg:mt-0"
                onClick={() => navigate('/All_sids')}
              >
                <ArchiveBoxArrowDownIcon className='h-36 w-36 text-green-500 mr-2' />
                <h2 className="text-xl text-gray-800 mt-4">Other Insurance</h2>
              </div>
              {/* Stock Management Container */}
              {/* <div
                className="flex flex-col items-center bg-green-50 shadow-lg rounded-lg p-6 cursor-pointer hover:shadow-xl transition duration-200 w-full mt-6 lg:mt-0"
              ...
              >
                <BanknotesIcon className='h-36 w-36 text-green-500 mr-2' />
                <h2 className="text-xl text-gray-800 mt-4">Insurance Capture</h2>
              </div> */}
            </div>
          )}
        </div>
